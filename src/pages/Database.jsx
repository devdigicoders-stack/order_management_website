      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        ...
        <div className="flex flex-col sm:flex-row gap-3 w-full md:w-auto">
          ...
          <button 
            ...
            className="w-full sm:w-auto justify-center bg-blue-600 text-white px-4 py-2 rounded-md text-sm font-medium hover:bg-blue-700 shadow-sm flex items-center"
          >
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-gray-900/60 backdrop-blur-sm overflow-y-auto" onClick={() => setShowAddModal(false)}>
          ...
          >
            <div className="bg-white px-6 pt-6 pb-6">
              ...
              {user?.role === 'staff' && (
                <div className="mb-5 bg-blue-50 text-blue-800 p-3 rounded-lg text-sm border border-blue-100">
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <input {...register('company')} type="text" className="w-full border-gray-300 rounded-lg shadow-sm p-2.5 border focus:border-blue-500 focus:ring-blue-500" />
                    {errors.company && <p className="text-red-500 text-xs mt-1">{errors.company.message}</p>}
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1">Model</label>
                    <input {...register('model')} type="text" className="w-full border-gray-300 rounded-lg shadow-sm p-2.5 border focus:border-blue-500 focus:ring-blue-500" />
                    {errors.model && <p className="text-red-500 text-xs mt-1">{errors.model.message}</p>}
                  </div>
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Description</label>
                  <input {...register('description')} type="text" className="w-full border-gray-300 rounded-lg shadow-sm p-2.5 border focus:border-blue-500 focus:ring-blue-500" />
                ...
                <div className="grid grid-cols-2 gap-4">
                  {user?.role === 'admin' && (
                    <div>
                      ...
                      <input {...register('cuft', { valueAsNumber: true })} type="number" step="0.01" className="w-full border-gray-300 rounded-lg shadow-sm p-2.5 border focus:border-blue-500 focus:ring-blue-500" />
                  ...
                  <div className={user?.role === 'staff' ? "col-span-2" : ""}>
                    ...
                    <input {...register('category')} type="text" className="w-full border-gray-300 rounded-lg shadow-sm p-2.5 border focus:border-blue-500 focus:ring-blue-500" />
                  </div>
                </div>
                <div className="pt-6 mt-2 flex justify-end space-x-3">
                  ...
                  <button type="submit" className="px-4 py-2 bg-blue-600 border border-transparent rounded-lg shadow-sm text-sm font-medium text-white hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors">
