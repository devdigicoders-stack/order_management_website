    ...
    <div className="max-w-6xl mx-auto space-y-6 pb-20 md:pb-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <div className="bg-white p-5 rounded-xl shadow-sm border border-gray-200">
          <div className="flex items-center space-x-3 mb-2">
            <div className="w-8 h-8 bg-blue-100 rounded-full flex items-center justify-center text-blue-600"><ShoppingCart className="w-4 h-4" /></div>
            <p className="text-xs font-medium text-gray-500">Total Items Ordered</p>
          </div>
          <p className="text-xl font-bold text-gray-900">{totalItemsOrdered}</p>
        </div>
        ...
        <Link to="/notifications" className="bg-white p-5 rounded-xl shadow-sm border border-gray-200 hover:border-blue-300 transition-colors block">
          <div className="flex items-center space-x-3 mb-2">
          ...
          <p className="text-xl font-bold text-gray-900">{unreadNotifs} Unread</p>
        </Link>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
         ...
         <div className="bg-blue-50 border border-blue-100 p-4 rounded-xl flex justify-between items-center">
            <div>
              <p className="text-sm font-medium text-blue-600">Submitted Orders</p>
              <p className="text-xl font-bold text-blue-900">{submittedOrders}</p>
            </div>
         ...
         <div className="bg-green-50 border border-green-100 p-4 rounded-xl flex justify-between items-center">
            <div>
              ...
              <p className="text-xl font-bold text-green-900">{approvedOrders}</p>
            </div>
