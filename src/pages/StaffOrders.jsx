...
export const StaffOrders = () => {
 ...
 case 'submitted': return <span className="px-2.5 py-1 bg-indigo-100 text-indigo-700 rounded-full text-xs font-medium flex items-center"><Clock className="w-3 h-3 mr-1"/> Submitted</span>;
 ...
 <Link 
 to="/orders"
 className="bg-indigo-600 text-white px-4 py-2 rounded-md text-sm font-medium hover:bg-indigo-700 shadow-sm flex items-center"
 >
 ...
 <Link to={`/orders`} className="text-indigo-600 hover:text-indigo-900 inline-flex items-center px-3 py-1 bg-indigo-50 rounded-md transition-colors">
 ...
 <Link to="/orders" className="mt-4 text-indigo-600 font-medium hover:underline">Create your first order</Link>
 </div>
 </td>
 </tr>
 )}
 ...
 <table className="min-w-full divide-y divide-gray-200 border border-gray-200 rounded-lg overflow-x-auto overflow-hidden">
 ...
 <p className="text-xl font-semibold text-gray-900">{selectedOrder.items.reduce((s, i) => s + i.quantity, 0)}</p>
 </div>
 <div>
