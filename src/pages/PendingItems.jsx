          ...
          <table className="min-w-full divide-y divide-gray-200">
            <thead className="bg-gray-50 sticky top-0 z-10 shadow-sm">
              <tr>
                ...
                <th className="px-6 py-3 text-center text-xs font-bold text-orange-600 uppercase tracking-wider">Pending Quantity</th>
              </tr>
            </thead>
            <tbody className="bg-white divide-y divide-gray-200">
              {pendingData.map((item) => (
                <tr key={item.id} className="hover:bg-gray-50 transition-colors">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-orange-600 text-center font-bold">{item.pending}</td>
                </tr>
              ))}
